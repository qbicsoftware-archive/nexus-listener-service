...
public class NexusListenerCommand extends AbstractCommand {
		...
		@Option(names={"-f", "--portlet-folder"}, description="Folder on which portlets are copied.", required=true)
	    public String outPortlet;
		
		@Option(names={"-o", "--non-portlet-folder"}, description="Folder on which non-portlets are copied.", required=true)
